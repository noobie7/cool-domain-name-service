...
contract Domains is ERC721URIStorage { 
    ...
    constructor( string memory _tld ) payable ERC721("AF Name Service", "ANS") {
    ...
    function register( string calldata name ) public payable {
        ...
        require(msg.value >= _price, "Not enough Matic LOL!");
        ...
        console.log("%s.%s is registered by %s", name , tld, msg.sender);
    ...
    function getDomainOwnerAddress(string calldata name) public view returns (address){
        return domains[name];
    }
    ...
    function withdraw() public onlyOwner  {
        ...
        require(success, "Not enough matic!");
    }
